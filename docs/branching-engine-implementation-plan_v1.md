...
- Typeform (`packages/runtime/src/ui/react/UniversalTypeform.tsx`):
...
- Classic (`packages/runtime/src/ui/react/UniversalClassic.tsx`):
...
- Update `UniversalClassic` to filter by `visibleSet`.
