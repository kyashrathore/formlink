...
export function ParamsConfigurator({
  formId,
  currentItem,
  schemaKeys,
  schemaLoading,
  ...
  // Local-only subcomponent to keep file count low
  ...
  return (
    <div className="mt-3 space-y-1.5">
      ...
      <div className="rounded-md border">
        ...
        <div>
          {(() => {
            const suggested = flattenScalarPaths(
      ...
      <Button
        ...
        onClick={async () => {
          ...
          try {
            ...
            // Ephemeral view save path
            if (!(activeView as any).saved) {
              const payload = {
                viewName: (activeView as any).name || "New View",
