  ...
  switch (type) {
    case "popup":
      return {
        element: `<script
  src="${popupScriptUrl}"
  data-formlink-url="${url}"
  data-formlink-popup-bg-color="black"
  data-formlink-popup-icon-color="#ffffff"
  data-formlink-popup-icon-type="default"
  async
>
</script>`,
        script: null,
