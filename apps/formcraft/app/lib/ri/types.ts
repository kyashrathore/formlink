...
export const RISortSchema = z.object({
  by: z.string(),
...
const SegmentationSchema = z.object({
  ...
  filters: z
    .array(
      z.object({ field: z.string(), op: z.string(), value: z.any().optional() })
    )
    .optional(),
})
...
const AdvancedArgsSchema = z.object({
...
const TrendArgsSchema = z
  .object({
    field: z.string().default("created_at").optional(),
    window: z
      .string()
      .regex(/^\d+(d|w|m)$/i)
      .default("7d")
...
export const RISidecarSchema = z.object({
  proposed_keys: z
    .array(
      z.object({
        key: z.string(),
        ...
        index_hint: z.enum(["none", "gin", "btree"]).default("none").optional(),
      })
    )
    .optional(),
  virtual_columns: z
...
// Top-level UI spec
export const RIUISchema = z.object({
  columns: z.array(z.string()).default(["created_at", "status"]),
  sort: RISortSchema.optional(),
  insights_spec: z.array(RIInsightSpecSchema).min(2),
})

// RPC (server) spec
export const RIRPCSchema = z.object({
...
// Plan meta
export const RIFollowupItemSchema = z.object({
  kind: z
...
export const RIMetaSchema = z.object({
...
// Full plan schema
export const RIPlanSchema = z.object({
  rpc: RIRPCSchema,
  ui: RIUISchema,
  actions: z
    .array(
...
export const RIPlanResponseSchema = z.object({
...
export const RIRequestSchema = z.object({
