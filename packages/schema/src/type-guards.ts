...
export function isTextQuestion(
  question: Question,
): question is Question & { type: TextQuestion } {
  return question.type.name === "text";
}

export function isChoiceQuestion(
  question: Question,
): question is Question & { type: ChoiceQuestion } {
  return (
...
export function isSingleChoiceQuestion(
  question: Question,
): question is Question & { type: ChoiceQuestion & { name: "singleChoice" } } {
...
export function isMultipleChoiceQuestion(
  ...
  type: ChoiceQuestion & { name: "multipleChoice" };
} {
...
export function isRatingQuestion(
  question: Question,
): question is Question & { type: RatingQuestion } {
  return question.type.name === "rating";
}

export function isDateQuestion(
  question: Question,
): question is Question & { type: DateQuestion } {
  return question.type.name === "date";
}

export function isRankingQuestion(
  question: Question,
): question is Question & { type: RankingQuestion } {
  return question.type.name === "ranking";
}

export function isFileUploadQuestion(
  question: Question,
): question is Question & { type: FileUploadQuestion } {
  return question.type.name === "fileUpload";
}

export function isAddressQuestion(
  question: Question,
): question is Question & { type: AddressQuestion } {
  return question.type.name === "address";
}

export function isLinearScaleQuestion(
  question: Question,
): question is Question & { type: LinearScaleQuestion } {
  return question.type.name === "linearScale";
}

export function isLikertScaleQuestion(
  question: Question,
...
export function hasOptions(
  question: Question,
): question is Question & { type: ChoiceQuestion | RankingQuestion } {
  return isChoiceQuestion(question) || isRankingQuestion(question);
}

export function hasConfig(
  question: Question,
): question is Question & { type: RatingQuestion | LinearScaleQuestion } {
...
export function getQuestionTypeName(question: Question): string {
  if (!question.type?.name) {
    throw new Error(
      `Invalid question type structure for question ${question.id}`,
    );
  }
...
export function getRatingConfig(question: Question): {
  min: number;
  max: number;
  step: number;
  minLabel?: string;
...
export function getLinearScaleConfig(question: Question): {
  start: number;
  end: number;
  step: number;
  startLabel?: string;
