...
export class StyleMapper {
  ...
  private mapColors(colors: any): any {
    ...
    return {
      ...
      secondaryHover: colors.secondaryHover || this.darken(colors.secondary || colors.primary, 10),
      secondaryActive: colors.secondaryActive || this.darken(colors.secondary || colors.primary, 20),
      secondaryForeground: colors.secondaryForeground || '#ffffff',
      
      // Backgrounds
      background: colors.background || '#ffffff',
      backgroundAlt: colors.backgroundAlt || this.lighten(colors.background || '#ffffff', 5),
      backgroundOverlay: 'rgba(0, 0, 0, 0.5)',
      
      // Text colors
      text: colors.text || '#212529',
      textMuted: colors.textMuted || this.lighten(colors.text || '#212529', 40),
      textDisabled: colors.textDisabled || this.lighten(colors.text || '#212529', 60),
      textPlaceholder: colors.textPlaceholder || this.lighten(colors.text || '#212529', 50),
  ...
  private mapTypography(typography: any): any {
    ...
    return {
      fonts: {
        heading: typography.fonts?.heading || typography.fonts?.body || 'sans-serif',
        body: typography.fonts?.body || 'sans-serif',
        input: typography.fonts?.input || typography.fonts?.body || 'sans-serif',
        button: typography.fonts?.button || typography.fonts?.body || 'sans-serif',
