  ...
  const handleUpload = useCallback(
    async (file: File) => {
      if (onFileUpload) {
        ...
        console.warn(
          "[UnifiedFileUpload] handleUpload called but onFileUpload is undefined",
        );
      }
    },
      ...
      >
        ...
        {isUploading && (
          ...
          >
            ...
            <div
              className="w-full bg-accent rounded-full h-2 mt-4"
              role="progressbar"
              aria-valuemin={0}
              aria-valuemax={100}
              aria-valuenow={100}
      ...
      <div className="relative">
        ...
        >
          <div className="text-center space-y-1">
            <p className="text-base font-medium">Upload files</p>
            <p className="text-xs text-muted-foreground">
              Drag and drop or click to browse
            </p>
            {maxSize && (
          ...
          {onSubmit && !isUploading && (
            ...
            >
              <Button
                ...
                size="lg"
              >
                Continue with {currentFiles.length} file
