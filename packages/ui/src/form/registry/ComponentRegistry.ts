...
export type FormInputType = 'text' | 'email' | 'url' | 'tel' | 'password' | 'textarea' | 
  'select' | 'multiselect' | 'multipleChoice' | 'rating' | 'date' | 'file' | 'fileUpload' | 'linear-scale' | 
  'address' | 'phone' | 'country' | 'likert-scale' | 'ranking';
 ...
 */
const identityTransformer = (props: any, type: FormInputType, mode: FormInputMode) => props;

/**
 * Text input transformer - handles type overrides and multiline for textarea
 */
const textInputTransformer = (props: any, type: FormInputType, mode: FormInputMode) => {
 ...
 */
const unifiedTransformer = (props: any, type: FormInputType, mode: FormInputMode) => ({
  ...props,
  mode
});
 ...
 */
const linearScaleTransformer = (props: any, type: FormInputType, mode: FormInputMode) => {
 ...
 */
export function getComponent(type: FormInputType, mode: FormInputMode): ComponentType<any> | null {
 ...
 */
export function transformComponentProps(props: any, type: FormInputType, mode: FormInputMode): any {
  const entry = componentRegistry[type];
  if (!entry) {
    return props;
  }
 ...
 */
export function addComponent(type: FormInputType, entry: ComponentRegistryEntry): void {
